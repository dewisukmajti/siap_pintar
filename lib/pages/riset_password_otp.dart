...
class RisetPasswordOtpPage extends StatefulWidget {
  final String method;
  final String contact;

  const RisetPasswordOtpPage({
    Key? key,
  ...
  @override
  _RisetPasswordOtpPageState createState() => _RisetPasswordOtpPageState();
}

class _RisetPasswordOtpPageState extends State<RisetPasswordOtpPage> {
