                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Sign Up Button dengan warna merah
                        Container(
                        ...
                        // Forgot password (bisa dihilangkan untuk sign up atau diganti dengan Terms)
                        Center(
                          child: TextButton(
                            onPressed: () {
                        ...
                        Container(
                          ...
                          child: OutlinedButton(
                            onPressed: () {
                              print('Google signup from sign up page');
                            },
                        ...
                        // Sign in link (kebalikan dari sign in page)
                        Center(
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
